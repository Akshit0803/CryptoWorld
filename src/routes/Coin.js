  ...
  <div>
    <div className="coin-container">
      <div className="content">
         <h1><span className="gold">{coin.name}</span></h1>
      </div>
      <div className="content">
        <div className="rank">
        ...
        <div className="coin-price">
          {coin.market_data?.current_price ? <h1><span className="green">$</span>{coin.market_data.current_price.usd.toLocaleString()}</h1> : null}
        ...
        <div className="stats">
          <div className="left">
            <div className="row">
              ...
              {coin.market_data?.low_24h? <p><span className="green">$</span>{coin.market_data.low_24h.usd.toLocaleString()}</p> : null} 
            </div>
            <div className="row">
              <h4>24 Hour Highest</h4>
              {coin.market_data?.high_24h? <p><span className="green">$</span>{coin.market_data.high_24h.usd.toLocaleString()}</p> : null} 
            </div>
          </div>
          <div className="right">
            <div className="row">
              <h4>Market Cap</h4>
              {coin.market_data?.market_cap? <p><span className="green">$</span>{coin.market_data.market_cap.usd.toLocaleString()}</p> : null} 
            </div>
            <div className="row">
